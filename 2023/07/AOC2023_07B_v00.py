...
def determine_hand_type(hand):
    ...
    if hand == "JJJJJ":
        hand = "AAAAA"
    elif "J" in hand:#If hand contains a joke find best value for joker
        hand_woJ = hand.replace("J","")
        counts_woJ = Counter(hand_woJ)
        counts_list_woJ = counts_woJ.most_common()
        joker = counts_list_woJ[0][0]
