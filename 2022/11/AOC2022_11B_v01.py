...
def inspect_item(item,monkey):
    ...
    return monkey_no_to_throw_to, item
...
with open("input_11_test.txt") as input_dataf:
...
print_rounds = [1,5,20,100,1000,2000,3000,4000,5000,6000,7000,8000,9000,10000]
...
while round < no_rounds:
    ...
    for i,monkey in enumerate(monkeys):
        ...
        for k,item in enumerate(items_held):
            [monkey_no_to_throw_to, item] = inspect_item(item,monkey)#Performs the inspection by the monkey
